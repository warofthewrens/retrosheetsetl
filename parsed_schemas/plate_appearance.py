...
class PlateAppearance(Schema):
    ...
    batting_team_away = fields.Boolean(data_val = 'is_away')
    outs = fields.Integer()
    ...
    hit_loc = fields.String()
    error_player_id = fields.String()
    batter_dest = fields.Integer()
    first_dest = fields.Integer()
    second_dest = fields.Integer()
    third_dest = fields.Integer()
